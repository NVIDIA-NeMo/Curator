---
layout: overview
slug: nemo-curator/nemo_curator/stages/function_decorators
title: nemo_curator.stages.function_decorators
---
...
| Name | Description |
|------|-------------|
| [`processing_stage`](#nemo_curator-stages-function_decorators-processing_stage) | Decorator that converts a function into a :class:`ProcessingStage`. |

### Data

[`TIn`](#nemo_curator-stages-function_decorators-TIn)

[`TOut`](#nemo_curator-stages-function_decorators-TOut)

### API

<Anchor id="nemo_curator-stages-function_decorators-processing_stage">

<CodeBlock links={{"nemo_curator.stages.resources.Resources":"/nemo-curator/nemo_curator/stages/resources#nemo_curator-stages-resources-Resources","nemo_curator.stages.base.ProcessingStage":"/nemo-curator/nemo_curator/stages/base#nemo_curator-stages-base-ProcessingStage"}} showLineNumbers={false} wordWrap={true}>
...
) -> collections.abc.Callable[[Callable[[TIn], TOut | list[TOut]]], nemo_curator.stages.base.ProcessingStage]
```
...
<Anchor id="nemo_curator-stages-function_decorators-TIn">

<CodeBlock showLineNumbers={false} wordWrap={true}>

```python
nemo_curator.stages.function_decorators.TIn = TypeVar('TIn', bound=Task)
```
...
<Anchor id="nemo_curator-stages-function_decorators-TOut">

<CodeBlock showLineNumbers={false} wordWrap={true}>

```python
nemo_curator.stages.function_decorators.TOut = TypeVar('TOut', bound=Task)
```
