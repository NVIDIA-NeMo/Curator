...
For downloading and processing data from **remote sources** like ArXiv, Common Crawl, and Wikipedia, refer to the [Data Acquisition Concepts](/docs/about/concepts/text/data/acquisition) page which covers:
