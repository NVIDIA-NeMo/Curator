...
<Card title="Split and Deduplicate Videos" href="/video/tutorials/split/dedup">
Split videos and then remove near-duplicates using KMeans + Pairwise semantic dedup.
splitting
semantic-deduplication
</Card>

<Card title="Pipeline Customization Series" href="/video/tutorials/pipeline/cust/series">
