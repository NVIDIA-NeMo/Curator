...
<Tip>
If you don't have a GPU available, you can skip the ASR inference stage and work with pre-existing transcriptions. See the [Custom Manifests](/load-data/custom-manifests) guide for details.
</Tip>
...
- **[Custom Manifests](/load-data/custom-manifests)**: Process your own audio datasets
- **[WER Filtering](/process-data/quality-assessment/wer-filtering)**: Advanced quality filtering techniques
- **[Duration Filtering](/process-data/quality-assessment/duration-filtering)**: Filter by audio length and speech rate
- **[NeMo ASR Models](/process-data/asr-inference/nemo-models)**: Explore available ASR models for different languages
...
- **[FLEURS Dataset](/load-data/fleurs-dataset)**: Detailed FLEURS dataset documentation
- **[Quality Assessment](/process-data/quality-assessment/index)**: Comprehensive quality metrics guide
- **[Save & Export](/save-export)**: Advanced export options and formats
