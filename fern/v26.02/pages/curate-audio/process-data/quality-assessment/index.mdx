...
```
<Note>
For a complete example of using speech rate metrics in a pipeline, refer to the **[Duration Filtering](/duration-filtering)** guide.
</Note>
...
- **[WER Filtering](/wer-filtering)** - Detailed guide to Word Error Rate filtering
- **[Duration Filtering](/duration-filtering)** - Audio length and speech rate filtering
- **[Audio Analysis](/audio-analysis/index)** - Audio file analysis and validation
