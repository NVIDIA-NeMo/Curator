...
<Card title="Read Existing Data" href="/text/load/data/read/existing">
Read existing JSONL and Parquet datasets using Curator's reader stages
jsonl
parquet
</Card>

<Card title="arXiv" href="/text/load/data/arxiv">
...
<Card title="Common Crawl" href="/text/load/data/common/crawl">
...
<Card title="Wikipedia" href="/text/load/data/wikipedia">
...
<Card title="Custom Data Sources" href="/text/load/data/custom">
...
<Card title="Language Management" href="/process-data/language-management/index">
...
<Card title="Content Processing & Cleaning" href="/process-data/content-processing/index">
...
<Card title="Deduplication" href="/process-data/deduplication/index">
...
<Card title="Quality Assessment & Filtering" href="/process-data/quality-assessment/index">
...
<Card title="Specialized Processing" href="/process-data/specialized-processing/index">
Domain-specific processing for code and advanced curation tasks
code-processing
</Card>

<Card title="Synthetic Data Generation" href="/synthetic/index">
