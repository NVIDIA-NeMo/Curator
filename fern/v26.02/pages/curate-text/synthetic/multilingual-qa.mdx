...
- [synthetic-llm-client](/about/release-notes/migration-guide): Advanced client configuration and performance tuning
- [nemotron-cc-overview](/about/release-notes/migration-guide): Advanced pipelines for text transformation and knowledge extraction
