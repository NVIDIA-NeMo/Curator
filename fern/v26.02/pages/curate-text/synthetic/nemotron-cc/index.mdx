...
<Note>
For detailed information on quality scoring options, see [Quality Assessment & Filtering](/curate-text/process-data/quality-assessment).
</Note>
