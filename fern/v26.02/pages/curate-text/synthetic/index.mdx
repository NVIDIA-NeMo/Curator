...
<Card title="LLM Client Setup" href="/llm-client">
Configure OpenAI-compatible clients for NVIDIA APIs and custom endpoints
configuration
performance
</Card>

<Card title="Multilingual Q&A Generation" href="/multilingual-qa">
Generate synthetic Q&A pairs across multiple languages
quickstart
tutorial
</Card>

<Card title="Nemotron-CC Pipelines" href="/nemotron-cc/index">
