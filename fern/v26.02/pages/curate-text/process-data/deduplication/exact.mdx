...
For an overview of all duplicate removal options, refer to [Deduplication ](/text-process-data-dedup).
...
For comparison with other deduplication methods and guidance on when to use exact deduplication, refer to the [Deduplication overview ](/text-process-data-dedup).
