...
For removal, use `TextDuplicatesRemovalWorkflow` with the generated duplicate IDs. See [Exact Duplicate Removal ](/text-process-data-dedup-exact) for details.
</Tab>
...
For removal, use `TextDuplicatesRemovalWorkflow` with the generated duplicate IDs. See [Fuzzy Duplicate Removal ](/text-process-data-dedup-fuzzy) for details.
</Tab>
...
See [Semantic Deduplication ](/text-process-data-format-sem-dedup) for details.
</Tab>
...
<Card title="{octicon}`git-pull-request;1.5em;sd-mr-1` Exact Duplicate Removal" href="exact">
...
<Card title="{octicon}`git-compare;1.5em;sd-mr-1` Fuzzy Duplicate Removal" href="fuzzy">
...
<Card title="{octicon}`repo-clone;1.5em;sd-mr-1` Semantic Deduplication" href="semdedup">
...
- [Exact Duplicate Removal ](/text-process-data-dedup-exact)
- [Fuzzy Duplicate Removal ](/text-process-data-dedup-fuzzy)
- [Semantic Deduplication ](/text-process-data-format-sem-dedup)
...
- **New to deduplication**: Start with [Exact Duplicate Removal ](/text-process-data-dedup-exact) for the fastest approach
- **Need near-duplicate detection**: See [Fuzzy Duplicate Removal ](/text-process-data-dedup-fuzzy) for MinHash-based matching
- **Require semantic matching**: Explore [Semantic Deduplication ](/text-process-data-format-sem-dedup) for meaning-based deduplication

**For hands-on guidance**: See [Text Curation Tutorials ](/text-tutorials) for step-by-step examples.
