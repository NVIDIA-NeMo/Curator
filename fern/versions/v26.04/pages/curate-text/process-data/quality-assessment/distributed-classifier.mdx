...
<Note>
Classifiers from different tokenizer groups are **not** compatible. You cannot reuse tokens generated for a DeBERTa-based classifier with an AEGIS classifier, or vice versa.
</Note>
