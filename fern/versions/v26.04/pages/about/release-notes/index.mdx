...
Each stage collects these metrics through `StagePerfStats.num_items_processed` and the benchmark aggregates them across pipeline tasks. Both heuristic and model-based (Xenna) score filter benchmarks report these metrics automatically.
