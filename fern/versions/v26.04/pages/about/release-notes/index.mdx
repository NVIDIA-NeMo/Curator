...
- **Automatic Ray dashboard generation**: The Grafana setup now auto-generates Ray core, data, serve, and serve-deployment dashboards from the built-in Ray dashboard factory.
