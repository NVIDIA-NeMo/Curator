...
### Cosmos-Xenna 0.1.2 Incompatible with Ray Nightly Builds

Cosmos-Xenna 0.1.2 (shipped in 26.02) fails to start GPU workers when paired with Ray nightly builds or Ray versions newer than 2.43. The error is:
