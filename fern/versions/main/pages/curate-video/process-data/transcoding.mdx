...
- `SoftwareCodecMissingError`: install software H.264/HEVC/AV1 support with `bash /opt/Curator/tools/install_h264_support.sh`, or use `--transcode-encoder libvpx-vp9`.
