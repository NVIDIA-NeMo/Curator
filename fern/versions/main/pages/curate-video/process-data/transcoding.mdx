...
| `libopenh264` | CPU | Optional H.264 software encoder. Requires `install_ffmpeg.sh` or another FFmpeg build that includes it. |
...
- `SoftwareCodecMissingError`: install software H.264/HEVC/AV1 support with `bash /opt/Curator/tools/install_ffmpeg.sh`, or use `--transcode-encoder libvpx-vp9`.
