...
After generating captions, use the [Video Caption Quality Evaluation](/curate-video/process-data/caption-evaluation) workflow to build a fixed benchmark and compare caption-to-video alignment across models with Summarize-then-Align and CosmosEmbed1.
