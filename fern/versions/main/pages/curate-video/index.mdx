...
<Card title="Evaluate Caption Quality" href="/curate-video/process-data/caption-evaluation">
Build a diverse benchmark and compare caption-to-video alignment with Summarize-then-Align.
captions
evaluation
cosmos-embed1
</Card>
