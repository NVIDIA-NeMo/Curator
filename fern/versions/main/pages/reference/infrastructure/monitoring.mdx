...
For completed audio runs, `ManifestWriterStage` can write a
[terminal performance summary](/curate-audio/save-export#manifest-writer-with-a-terminal-performance-summary).
This JSON artifact complements, but does not replace, live monitoring.
