...
The extras do not install the `ffmpeg` command-line executable. For container and non-root installation options, see the [Installation Guide](/get-started/installation).
</Note>
