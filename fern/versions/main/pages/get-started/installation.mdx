...
```bash
curl -fsSL https://raw.githubusercontent.com/NVIDIA-NeMo/Curator/main/tools/check_ffmpeg.sh -o check_ffmpeg.sh
bash check_ffmpeg.sh --encoder h264_nvenc --encoder libvpx-vp9
```
...
bash /opt/Curator/tools/install_h264_support.sh --with-libopenh264
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/NVIDIA-NeMo/Curator/main/tools/check_lynx.sh -o check_lynx.sh
bash check_lynx.sh
```
