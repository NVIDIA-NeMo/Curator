...
<Card title="LLM Judge Runner" href="/main/curate-text/tutorials/llm-judge">
Follow this tutorial to prepare Common Crawl records, compare jusText and Trafilatura output, and inspect structured judge scores.
</Card>
