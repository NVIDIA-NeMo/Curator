...
rereads all files in bounded frames to predict and write every row. This keeps prediction and output
memory independent of the fit sample size. An explicit JSONL fit fraction uses the same two-pass I/O
pattern.
