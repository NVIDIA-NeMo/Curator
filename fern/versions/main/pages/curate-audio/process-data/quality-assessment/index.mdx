...
- **[Audio Tagging Tutorial](/curate-audio/tutorials/audio-tagging)** - Add per-segment bandwidth and SQUIM scores, then validate transcripts with second-pass WER and CER
