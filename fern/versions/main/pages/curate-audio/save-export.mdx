...
```json
{"audio_filepath": "/data/audio/sample_001.wav", "text": "hello world", "pred_text": "hello world", "wer_pct": 0.0, "duration": 2.1}
{"audio_filepath": "/data/audio/sample_002.wav", "text": "good morning", "pred_text": "good morning", "wer_pct": 0.0, "duration": 1.8}
```
...
| `wer_pct` | float | Word Error Rate percentage from `GetPairwiseWerStage` |
