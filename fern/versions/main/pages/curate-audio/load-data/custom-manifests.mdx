...
|-------|------|-------------|---------|
| `audio_filepath` | string | Absolute local path visible to every worker, or a shared storage URI | `/data/audio/sample.wav` |
