...
For details on filter structure and the filtering process, refer to [Data Processing Concepts](/docs/about/concepts/text/data/processing).
...
<Tabs>
<Tab title="Memory Efficient Processing">
```python
