...
Curator uses the same **4-step pipeline pattern** described in [Data Acquisition Concepts](/docs/about/concepts/text/data/acquisition) for custom data loading. Each step uses an abstract base class with corresponding processing stages that compose into pipelines.

---

## Architecture Overview

For detailed information about the core components and data flow, see [Data Acquisition Concepts](/docs/about/concepts/text/data/acquisition) and [Data Loading Concepts](/docs/about/concepts/text/data/loading).
...
For executor options and configuration, refer to [Reference Execution Backends](/docs/reference/execution/backends).
