---
title: Get Started with Video Curation
...
<Tabs>
<Tab title="PyPi Without internvideo2">
```bash
...
<Tab title="Source Without internvideo2">
```bash
...
<Tab title="PyPi With internvideo2">
```bash
...
<Tab title="Source With internvideo2">
```bash
git clone https://github.com/NVIDIA-NeMo/Curator.git
cd Curator
uv sync --extra video_cuda12 --all-groups
...
<Note>
For details on container environments and configurations, see the Container Environments documentation.
</Note>
</Tab>
</Tabs>
