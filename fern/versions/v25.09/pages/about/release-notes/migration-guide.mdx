...
Connect to a Ray cluster, which can manage tasks across CPU or GPU-backed nodes. For cluster setup details, refer to [Production Deployment Requirements](/admin/admin/deployment/requirements) and the [Ray documentation](https://docs.ray.io/en/latest/cluster/getting-started.html).
...
For questions about migration or other topics, refer to the [Migration FAQ](/about/release-notes/about/release-notes/migration-faq).
