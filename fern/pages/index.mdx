...
<Card title="About Curator" href="/docs/about">
Overview of NeMo Curator and its capabilities.
</Card>

<Card title="Key Features" href="/docs/about/key-features">
Discover the main features of NeMo Curator for data curation.
</Card>

<Card title="Concepts" href="/docs/about/concepts">
...
<Card title="Text Beginner Tutorial" href="/docs/get-started/text">
Learn the basics of text data processing with NeMo Curator.
</Card>

<Card title="Image Beginner Tutorial" href="/docs/get-started/image">
Learn the basics of image data processing with NeMo Curator.
</Card>

<Card title="Video Beginner Tutorial" href="/docs/curate-video/tutorials/beginner">
Learn the basics of video pipeline construction and execution.
</Card>

<Card title="Audio Beginner Tutorial" href="/docs/get-started/audio">
