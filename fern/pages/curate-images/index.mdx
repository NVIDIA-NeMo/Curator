...
<Card title="Concepts" href="/docs/about/concepts/image">
Learn about ImageBatch, ImageObject, and pipeline stages for efficient image curation
</Card>

<Card title="Get Started" href="/docs/get-started/image">
...
<Card title="Tar Archives" href="/docs/image/load/data/tar/archives">
...
<Card title="Embeddings" href="/docs/image/process/data/embeddings">
Generate image embeddings using CLIP models.
</Card>

<Card title="Filters" href="/docs/image/process/data/filters">
Apply built-in filters for aesthetic quality and NSFW content filtering.
</Card>

<Card title="Deduplication" href="/docs/image/tutorials/dedup">
...
<Card title="Execution Backends" href="/docs/reference/execution/backends">
Configure Ray-based executors for distributed processing and resource management.
</Card>

<Card title="Performance Optimization" href="/docs/image/load/data/tar/archives">
...
<Card title="Save & Export" href="/docs/image/save/export">
