...
<Card title="Data Loading" href="/docs/about/concepts/image/data/loading">
Load and manage large-scale image datasets for curation workflows.
</Card>

<Card title="Data Processing" href="/docs/about/concepts/image/data/processing">
Embedding generation, classification (aesthetic, NSFW), filtering, and deduplication for images.
</Card>

<Card title="Data Export" href="/docs/about/concepts/image/data/export">
Export, save, and reshard curated image datasets for downstream use.
</Card>

<Card title="Image Curation Quickstart" href="/docs/get-started/image">
...
<Card title="Architecture" href="/docs/about/concepts/video/architecture">
Distributed processing, Ray-based foundation, and autoscaling for video curation.
</Card>

<Card title="Key Abstractions" href="/docs/about/concepts/video/abstractions">
Stages, pipelines, and execution modes in video curation workflows.
</Card>

<Card title="Data Flow" href="/docs/about/concepts/video/data/flow">
How data moves through the system, from ingestion to output, for efficient large-scale video curation.
</Card>

<Card title="Video Curation Quickstart" href="/docs/get-started/video">
...
<Card title="Deployment Options" href="/docs/admin/overview">
