...
<Card title="Text Curation Concepts" href="/docs/about/concepts/text">
Learn about text data curation, covering data loading and processing (filtering, classification, deduplication).
</Card>

<Card title="Image Curation Concepts" href="/docs/about/concepts/image">
...
<Card title="Video Curation Concepts" href="/docs/about/concepts/video">
...
<Card title="Audio Curation Concepts" href="/docs/about/concepts/audio">
...
<Card title="Deduplication Concepts" href="/docs/about/concepts/deduplication">
