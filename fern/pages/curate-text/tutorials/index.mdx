...
<Card title="Pipeline Architecture" href="/docs/about/concepts/text/data/curation/pipeline">
Core processing stages and pipeline concepts for text curation workflows
</Card>

<Card title="Quality Assessment" href="/docs/../process/data/quality/assessment/index">
Scoring and filtering techniques used in tutorials
</Card>

<Card title="Data Loading" href="/docs/../load/data/index">
Loading data from various sources
</Card>

<Card title="Distributed Classification" href="/docs/../process/data/quality/assessment/distributed/classifier">
