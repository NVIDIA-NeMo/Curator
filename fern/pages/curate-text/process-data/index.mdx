...
Process text data you've loaded through NeMo Curator's [pipeline architecture](/docs/about/concepts/text/data/loading).
...
<Card title="Language Identification" href="/docs/language/management/language">
Identify document languages and separate multilingual datasets
</Card>

<Card title="Stop Words" href="/docs/language/management/stopwords">
...
<Card title="Text Cleaning" href="/docs/content/processing/text/cleaning">
...
<Card title="Exact Duplicate Removal" href="/docs/deduplication/exact">
Identify and remove character-for-character duplicates using MD5 hashing
</Card>

<Card title="Fuzzy Duplicate Removal" href="/docs/deduplication/fuzzy">
Identify and remove near-duplicates using MinHash and LSH similarity
</Card>

<Card title="Semantic Deduplication" href="/docs/deduplication/semdedup">
...
<Card title="Heuristic Filtering" href="/docs/quality/assessment/heuristic">
Filter text using configurable rules and metrics
</Card>

<Card title="Classifier Filtering" href="/docs/quality/assessment/classifier">
Filter text using trained quality classifiers
</Card>

<Card title="Distributed Classification" href="/docs/quality/assessment/distributed/classifier">
...
<Card title="Code Processing" href="/docs/specialized/processing/code">
