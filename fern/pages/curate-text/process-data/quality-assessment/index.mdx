...
NeMo Curator's filtering framework is built around several key components that work within the [data processing architecture](/docs/about/concepts/text/data/processing):
...
<Card title="Heuristic Filtering" href="/docs/heuristic">
Filter text using configurable rules and metrics
</Card>

<Card title="Classifier Filtering" href="/docs/classifier">
Filter text using trained quality classifiers
</Card>

<Card title="Distributed Classification" href="/docs/distributed/classifier">
