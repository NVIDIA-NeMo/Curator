...
Each specialized processor understands the unique characteristics of its target domain and applies appropriate metrics and thresholds within the broader [data processing framework](/docs/about/concepts/text/data/processing).
...
<Card title="Code Processing" href="/docs/code">
