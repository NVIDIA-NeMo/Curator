...
NeMo Curator provides three deduplication approaches: exact matching (MD5 hashing), fuzzy matching (MinHash + LSH), and semantic matching (embeddings). All methods are GPU-accelerated and integrate with the [data processing pipeline](/docs/about/concepts/text/data/processing).
...
For removal, use `TextDuplicatesRemovalWorkflow` with the generated duplicate IDs. See [Exact Duplicate Removal](/docs/text/process/data/dedup/exact) for details.
</Accordion>
</Tab>
...
For removal, use `TextDuplicatesRemovalWorkflow` with the generated duplicate IDs. See [Fuzzy Duplicate Removal](/docs/text/process/data/dedup/fuzzy) for details.
</Accordion>
</Tab>
...
See [Semantic Deduplication](/docs/text/process/data/dedup/semdedup) for details.
</Accordion>
...
<Card title="Exact Duplicate Removal" href="/docs/exact">
Identify and remove character-for-character duplicates using MD5 hashing
</Card>

<Card title="Fuzzy Duplicate Removal" href="/docs/fuzzy">
Identify and remove near-duplicates using MinHash and LSH similarity
</Card>

<Card title="Semantic Deduplication" href="/docs/semdedup">
...
- [Exact Duplicate Removal](/docs/text/process/data/dedup/exact)
- [Fuzzy Duplicate Removal](/docs/text/process/data/dedup/fuzzy)
- [Semantic Deduplication](/docs/text/process/data/dedup/semdedup)
...
- **New to deduplication**: Start with [Exact Duplicate Removal](/docs/text/process/data/dedup/exact) for the fastest approach
- **Need near-duplicate detection**: See [Fuzzy Duplicate Removal](/docs/text/process/data/dedup/fuzzy) for MinHash-based matching
- **Require semantic matching**: Explore [Semantic Deduplication](/docs/text/process/data/dedup/semdedup) for meaning-based deduplication

**For hands-on guidance**: See [Text Curation Tutorials](/docs/text/tutorials) for step-by-step examples.
