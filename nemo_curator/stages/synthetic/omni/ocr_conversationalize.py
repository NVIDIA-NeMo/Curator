...
class OCRConversationData(OCRData):
    ...
    def from_dict(cls, data: dict[str, Any]) -> "OCRConversationData":
        ...
        return cls(
            ...
            error=base.error,
            ocr_language_route=base.ocr_language_route,
            ocr_language_route_prompt=base.ocr_language_route_prompt,
            ocr_language_route_response_raw=base.ocr_language_route_response_raw,
            ocr_has_text=base.ocr_has_text,
            ocr_has_chinese=base.ocr_has_chinese,
            ocr_has_english=base.ocr_has_english,
            ocr_has_other_language=base.ocr_has_other_language,
