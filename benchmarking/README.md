...
| --- | --- | --- |
| LibriSpeech ASR | Full English FLEURS, 7.4908h: Xenna 92.45s, Ray Data 143.92s | Shared 600.0028h `openslr/librispeech_asr` manifest (CC BY 4.0), 173,029 unique clips with no repeated rows. Xenna meets the target at 10m42.52s processing / 11m04.09s wall on 8xA100. Ray Data requires recalibration after restoring the stock executor behavior. |
