...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Fixed image reader worker count (default: executor-managed)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Fixed image embedding worker count (default: executor-managed)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Fixed aesthetic scoring worker count (default: executor-managed)",
    )
    parser.add_argument(
        "--aesthetic-threshold",
        type=float,
