...
- **Add a page:** drop an MDX file under `fern/versions/v26.04/pages/` (the bleeding-edge tree) and wire it into `fern/versions/v26.04.yml`.
- **Release notes:** add to `fern/versions/v26.04/pages/` — never to this directory.
