...
```{important}
If you plan to use InternVideo2 embeddings, you must install InternVideo2 **before** running the pipeline. Refer to the [InternVideo2 installation instructions](../admin/installation.md#internvideo2-support-optional-for-video) for setup steps. The NeMo Curator container includes InternVideo2 pre-installed.
```
