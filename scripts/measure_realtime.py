...
def main():
    ...
    ap.add_argument("--slurm-log", type=str, default=None,
                    help="Slurm log file to auto-extract inference timing from timestamps")
    ap.add_argument("--wall-time", type=float, default=None,
                    help="Total inference wall time in seconds (for completed runs)")
    args = ap.parse_args()
