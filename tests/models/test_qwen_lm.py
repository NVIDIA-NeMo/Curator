...
class TestQwenLM:
    ...
    def test_initialization(self) -> None:
        ...
        assert self.qwen_lm.model_name == _QWEN_LM_MODEL_ID
    ...
    def test_custom_model_name(self) -> None:
        ...
        assert qwen_lm.model_name == custom_model
    ...
    def test_setup_with_fp8(
        ...
        mock_check_vllm.assert_called_once_with(self.qwen_lm.model_name)
    ...
    def test_download_weights_on_node_custom_model(self, mock_download: Mock) -> None:
        ...
        with patch("nemo_curator.models.qwen_lm.Path") as mock_path:
            ...
            QwenLM.download_weights_on_node(model_dir="/some/dir", model_name=custom_model)
    ...
    def test_download_weights_on_node_invalid_model(self) -> None:
        with pytest.raises(ValueError, match="must be a Qwen model"):
            QwenLM.download_weights_on_node(model_dir="/some/dir", model_name="mistralai/Mistral-7B-Instruct")
