...
"""Tests for the shared adapter contract: the ``ASRResult`` shape and ``ASRAdapter`` conformance."""
...
class _FakeASRAdapter:
    """Minimal hand-written ``ASRAdapter`` that echoes each item's language as the transcription."""
...
def test_asr_result_defaults() -> None:
    """The shape every adapter returns, and every consumer reads, must stay stable."""
...
# ----------------------------------------------------------------------
# Protocol conformance for an arbitrary adapter
# ----------------------------------------------------------------------
