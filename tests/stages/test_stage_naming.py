...
from nemo_curator.stages.base import _validate_stage_name, _camel_to_snake_case
...
def test_stage_naming_convention():
    ...
    def assert_stage_name_is_snake_case(stage_instance):
...
def test_class_names_are_camel_case():
    ...
    def assert_class_name_is_camel_case(cls):
        ...
        assert re.match(r'^[A-Z][a-zA-Z0-9]*$', class_name), \
            f"Class name '{class_name}' must be CamelCase"
