...
@pytest.mark.parametrize(
    "pattern",
    [
        "manifest__OP_5..3_CL_.jsonl",
        "audio__OP_10..0_CL_.tar",
    ],
)
def test_expand_nemo_path_rejects_reversed_ranges(pattern: str) -> None:
    with pytest.raises(ValueError, match="must be ascending"):
        _expand_nemo_path(pattern)
