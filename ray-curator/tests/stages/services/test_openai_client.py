...
from ray_curator.stages.services.openai_client import OpenAIClient, AsyncOpenAIClient
...
class TestOpenAIClient:
    ...
    def test_setup(self, mock_openai):
    ...
    @patch('ray_curator.stages.services.openai_client.OpenAI')
    def test_query_model_success(self, mock_openai):
    ...
    @patch('ray_curator.stages.services.openai_client.OpenAI')
    def test_query_model_multiple_choices(self, mock_openai):
...
class TestAsyncOpenAIClient:
    ...
    def test_setup(self, mock_async_openai):
    ...
    @pytest.mark.asyncio
    @patch('ray_curator.stages.services.openai_client.AsyncOpenAI')
    async def test_query_model_impl_success(self, mock_async_openai):
    ...
    @pytest.mark.asyncio
    @patch('ray_curator.stages.services.openai_client.AsyncOpenAI')
    async def test_query_model_impl_multiple_choices(self, mock_async_openai):
    ...
    @pytest.mark.asyncio
    @patch('ray_curator.stages.services.openai_client.AsyncOpenAI')
    async def test_integration_with_parent_retry_logic(self, mock_async_openai):
    ...
    @pytest.mark.asyncio
    @patch('ray_curator.stages.services.openai_client.AsyncOpenAI')
    async def test_concurrent_request_limiting(self, mock_async_openai):
