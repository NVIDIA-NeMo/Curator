...
class TestQwenLM:
    ...
    def test_setup_with_fp8(self, mock_path: Mock, mock_llm_class: Mock, mock_sampling_params_class: Mock, mock_tokenizer_class: Mock) -> None:
    ...
    @patch("ray_curator.models.qwen_lm.LLM")
    @patch("ray_curator.models.qwen_lm.Path")
    def test_setup_without_fp8(self, mock_path: Mock, mock_llm_class: Mock, mock_sampling_params_class: Mock, mock_tokenizer_class: Mock) -> None:
    ...
    def test_weight_file_path_construction(self) -> None:
        ...
        with patch("ray_curator.models.qwen_lm.Path") as mock_path:
            ...
            with patch("ray_curator.models.qwen_lm.LLM"), \
                 patch("ray_curator.models.qwen_lm.SamplingParams"), \
                 patch("ray_curator.models.qwen_lm.AutoTokenizer"):
