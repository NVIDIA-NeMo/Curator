...
def _prepare_speaker_tracks_for_mix(
    ...
    *,
    ...
    """Replace pauses using original manifest masks and prepare persistent track destinations."""
    ...
    for entry in entries:
        ...
        local_dst = session_scratch / f"{rec_id}.opus"
        persistent_dst = mixed_speaker_audio_path(audio_mixed_dir, speaker_id, session_id)
