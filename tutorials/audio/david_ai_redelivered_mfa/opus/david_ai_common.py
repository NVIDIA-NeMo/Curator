...
def mixed_speaker_audio_path(audio_mixed_dir: Path, speaker_id: str, session_id: str) -> Path:
    """Persistent pause-noise track used as one input to the session mix."""
    return audio_mixed_dir / "speakers" / f"{recording_id(speaker_id, session_id)}.opus"
